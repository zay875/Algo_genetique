...
ga = pd.read_csv("results_summary_GA_ALL_instances_chargui_gen_100.csv")
exact = pd.read_csv("results_exact_summary_with_chargui_instances_time_limit_2_h.csv")
...
output_file = "comparison_summary_GA_VS_Exact_chargui_intances_timelimit_2h_100_gen.csv"
save_cols = ["file name"]
