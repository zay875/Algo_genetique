...
results_df.to_csv("results_summary_GA_for_small_instance_with_time.csv", index=False)
print("\n✅ Tous les résultats enregistrés dans results_summary_GA_for_small_instance_with_time.csv")
